...
import { clampThinkingLevel, AssistantMessageEventStream } from "@earendil-works/pi-ai";
...
const OPENAI_TOOL_CALL_PROVIDERS = new Set(["openai", "openai-codex", "opencode", "openai-responses-codex"]);
